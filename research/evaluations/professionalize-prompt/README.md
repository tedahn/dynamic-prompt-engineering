...
- Model-aware challenger: `professionalize-prompt-model-aware@2026-07-30`; prototype only, tracked under `skills/professionalize-prompt/`, with evaluation case `E-020`
